...
def load_data(root, aclist):
    ...
    for file in file_list:
        file_name = root + file
        csi = np.load(file_name)#所有问题都是关于np.load这地方出来的
...
# dataset = load_data('Data\\', ['bed', 'fall', 'pickup', 'run', 'sitdown', 'walk', 'standup'])
...
test_data_loader = data_loader(dataset)
